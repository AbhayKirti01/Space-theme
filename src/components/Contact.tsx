        ...
        <div className="glass p-6 sm:p-12 md:p-24 rounded-[2rem] md:rounded-[3rem] relative overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-10 md:gap-16">
            <div>
              ...
              <p className="text-white/40 text-base md:text-xl mb-6 md:mb-12 max-w-md">
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div className="min-w-0 overflow-hidden">
                    ...
                    <div className="text-sm sm:text-xl font-medium break-all sm:break-normal">abhay.kirti25@gmail.com</div>
                  </div>
                </motion.a>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between">
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  ...
                  >
                    <social.icon size={20} className="sm:w-8 sm:h-8 group-hover:scale-110 transition-transform text-white/60 group-hover:text-white" />
                    <span className="text-[10px] sm:text-sm font-medium text-white/40 group-hover:text-white">{social.name}</span>
                  </motion.a>
                ))}
              </div>
              ...
              <div className="mt-8 md:mt-12 pt-8 md:pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-white/30 text-[10px] sm:text-sm text-center md:text-left">
                  © 2026 Abhay Kirti. All rights reserved.
                </div>
                <div className="flex gap-4 sm:gap-8 text-white/30 text-[10px] sm:text-sm">
